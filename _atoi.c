...
/**
 * _interactive - this function returns true if shell is interactive mode
 * @info: struct address
 *
 ...
 *@c: char to input
 *Return: it returns 1 if c is alphabetic, 0 otherwise
 */
...
/**
 *_atoi - it converts str to an integer
