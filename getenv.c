...
/**
 * _unsetenv - function that removes an env variable
...
/**
 * _setenv - it initializes a new env variable,
 *             or modify an existing one
 * @info: Struct that contains potential argus. Used to maintain
 *        constant function prototype.
 * @var: str env var property
 * @value: str env var value
 *  Return: every time returns 0
 */
