...
/**
 *struct passinfo - it contains pseudo-arguements to pass into a func,
 *		allowing uniform prototype for function pointer struct
 *@arg: str generated from getline containing args
 *@argv: array of str generated from arg
 *@path: str path for the current cmd
 *@argc: arg count
...
/**
 *struct builtin - it contains a builtin str and related function
